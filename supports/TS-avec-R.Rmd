...
- Dans l'equation (1), $y_t$ est representé par une tendance déterministe, alors que dans l'équation (2) la série est expliquée par ses chocs passés (i.e., une tendance stochastique).
