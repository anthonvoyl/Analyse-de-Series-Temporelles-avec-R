...
- La variable dépendante est l'augmentation des dépenses and les variables indépendantes sont les résidus de  cointegration et l'augmenation des revenus (plus une constante)
